	...
	<div class="container">
		...
		<form id="freeboard_form" class="freeboard_form" action="#" method="post">
			...
			<div class="text-center">	
				<button id="" type="submit" class="btn btn-comm-con">확인</button>
				<button id=""type="reset" class="btn btn-comm-con">취소</button>
				<a href="http://localhost:8080/coinweb_mobile/mypage/mypage.jsp"><button type="button" class="btn btn-comm-con">마이페이지</button></a>
			</div>
		</form>
...
<!-- foooter 부분.. --> 
	...
	<div id="mySidenav" class="sidenav">
		<a href="javascript:void(0)" class="closebtn" onclick="closeNav()"
			...
			href="http://localhost:8080/coinweb_mobile/freeboard/freeboard.jsp">자유게시판</a>
		<hr>
		<a href="#">랭킹</a>
		<hr>
